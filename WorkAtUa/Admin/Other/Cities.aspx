<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cities.aspx.cs" Inherits="WorkAtUa.Admin.Other.Cities" %>
    ...
    <div>
        <div id="sidebar">
            <div style="width: 1100px;  margin: 0 auto;">
                ...
                <div runat="server" id="itemCities" class="sidebarItem"><a href="Cities.aspx" style="color: white; text-decoration: underline;">Cities</a></div>
            ...
            <asp:UpdatePanel runat="server" ID="updatePanel" >
                <ContentTemplate>
                    <div style="padding-top: 100px;">
                        <asp:Repeater runat="server" ID="repCities" OnItemCommand="repCities_ItemCommand">
                           <HeaderTemplate>
                                <table>
                                    <th>Id</th>
                                    <th>Name</th>
