<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEmployer.aspx.cs" Inherits="WorkAtUa.EditEmployer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div id="mainContent">
        <div id="mainContentExp">
            <h1 id="mainContentExpTitle">Edit of employer</h1>
            <div id="mainContentExpFeautures">After you will spend a pair of minutes you will change your profile</div>
        </div>
